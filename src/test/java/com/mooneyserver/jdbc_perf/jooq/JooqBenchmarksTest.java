...
public class JooqBenchmarksTest {

  private JooqBenchmarks jb;

  @Before
  public void setUpSpeedmentConnection() {
    jb = new JooqBenchmarks();
    jb.initJooqDslContext();
  }
  ...
  public void simpleQueryWithWhereAndLimit() {
    ...
    Assert.assertEquals(DbDetails.FILTERED_ALBUM_QUERY_LIMIT_SIZE.intValue(),
        albums.size());
  ...
  public void queryWithJoinAndGroupBy() {
    ...
    Assert.assertEquals("Intro/ Low Dow",
        albumTracks.get("Alcohol Fueled Brewtality Live! [Disc 1]"));
    Assert.assertEquals("Heart Of Gold",
        albumTracks.get("Alcohol Fueled Brewtality Live! [Disc 2]"));
  }
